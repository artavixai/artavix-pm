        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CrmCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ProjectStage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    PerformedHours = table.Column<int>(type: "int", nullable: true),
                    CommittedServices = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProvidedServices = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Projects_Users_LastEditorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Weight = table.Column<int>(type: "int", nullable: true),
                    Progress = table.Column<int>(type: "int", nullable: false),
                    PlannedColor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExecutedColor = table.Column<string>(type: "nvarchar(max)", nullable: true),
